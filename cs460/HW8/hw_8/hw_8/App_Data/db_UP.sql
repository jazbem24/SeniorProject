...
CONSTRAINT[PK.dbo.Genres] PRIMARY KEY CLUSTERED(ID ASC)
); 
...
CONSTRAINT[FK_dbo.Genres_dbo.GenreID] FOREIGN KEY ([GenreID])REFERENCES [dbo].[Genres]([ID])
);
...
--ArtWork Table
INSERT INTO dbo.ArtWorks(Title, ArtistID)
VALUES 
('Circle Limit III', 1),
('Twon Tree', 1),
('Mona Lisa', 2),
